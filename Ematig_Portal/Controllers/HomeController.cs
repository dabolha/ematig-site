namespace Ematig_Portal.Controllers
{
    ...
    public class HomeController : BaseController
    {
        ...
        [Route("management", Name = HomeControllerRoute.GetManagement)]
        public ActionResult Management()
        {
            return this.View(HomeControllerAction.Management);
        }

        [Route("solutions", Name = HomeControllerRoute.GetSolutions)]
        ...
        public ActionResult Search(string query)
        {
            ...
            // and display your search results.
        ...
        public ActionResult OpenSearchXml()
        {
            ...
            string shortName = "ASP.NET MVC Boilerplate";
