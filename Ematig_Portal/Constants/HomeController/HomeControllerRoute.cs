namespace Ematig_Portal.Constants
{
    public static class HomeControllerRoute
    {
        public const string GetManagement = ControllerName.Home + "GetManagement";
        public const string GetSolutions = ControllerName.Home + "GetSolutions";
